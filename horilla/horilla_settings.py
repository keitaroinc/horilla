...
"""
DB_INIT_PASSWORD = settings.DB_INIT_PASSWORD
...
if settings.AWS_ACCESS_KEY_ID:
    ...
    AWS_S3_ADDRESSING_STYLE = settings.AWS_S3_ADDRESSING_STYLE
...
if settings.AWS_ACCESS_KEY_ID and "storages" in INSTALLED_APPS:
    settings.MEDIA_URL = f"{settings.MEDIA_URL}/{settings.NAMESPACE}/"
    settings.MEDIA_ROOT = f"{settings.MEDIA_ROOT}/{settings.NAMESPACE}/"